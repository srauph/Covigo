...
urlpatterns = [
    ...
    path('patient_reports/patient_report_modal/<int:user_id>/<str:date_updated>/', views.patient_report_modal,
         name='patient_report_modal'),
    path('patient_reports/patient_report_modal_table/<int:user_id>/<str:date_updated>/',
